...
this.searchOverlay[0].closest('.header.content').classList.add('hawk-search-open');this.pageHeader[0].classList.add('floating');}
...
this.searchOverlay[0].closest('.header.content').classList.remove('hawk-search-open');this.pageHeader[0].classList.remove('floating');}
...
this.initCustomizeSearchInputGroup('none');this.triggerScroll('sidebar sidebar-main');},triggerScroll:function(selector){let element=document.getElementsByClassName(selector);if(element.length<1){return;}
